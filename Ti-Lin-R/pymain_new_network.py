...
from full_test import run as run_cnn_full
...
if __name__ == '__main__':
    ...
    if table == -1:
        ...
        LBs, times = run_all_general('models/mnist_cnn_4layer_5_3', core=False,ada=True,skipsigmoid=True)
        LB.append(LBs)
        time.append(times)
        LBs, times = run_all_general('models/mnist_cnn_5layer_5_3', core=False,ada=True,skipsigmoid=True)
        LB.append(LBs)
        time.append(times)
        LBs, times = run_all_general('models/mnist_cnn_6layer_5_3', core=False,ada=True,skipsigmoid=True)
        LB.append(LBs)
        time.append(times)
        LBs, times = run_all_general('models/mnist_cnn_7layer_5_3', core=False,ada=True,skipsigmoid=True)
        LB.append(LBs)
        time.append(times)
        LBs, times = run_all_general('models/mnist_cnn_8layer_5_3', core=False,ada=True,skipsigmoid=True)
        LB.append(LBs)
        time.append(times)
        
        LBs, times = run_all_general('models/cifar_cnn_5layer_5_3', core=False,ada=True,cifar=True,skipsigmoid=True)
        LB.append(LBs)
        time.append(times)
        LBs, times = run_all_general('models/cifar_cnn_6layer_5_3', core=False,ada=True,cifar=True,skipsigmoid=True)
        LB.append(LBs)
        time.append(times)
        LBs, times = run_all_general('models/cifar_cnn_7layer_5_3', core=False,ada=True,cifar=True,skipsigmoid=True)
        LB.append(LBs)
        time.append(times)
