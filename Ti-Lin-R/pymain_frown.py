...
from cnn_bounds_full_frown import run as run_cnn_full
...
if __name__ == '__main__':
    ...
    printlog("-----------------------------------")
    if table == -1:
        LBs, times = run_all_general('/root/FROWN/pretrained_models/drive/net_8_20_relu/merged_bn_net', onlyrelu=True, core=False)
        LB.append(LBs)
        time.append(times)
    if table == 1:
