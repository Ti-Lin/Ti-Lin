...
if __name__ == '__main__':
    ...
    if table == -1:
        '''
        LBs, times = run_all_general('models/mnist_cnn_4layer_5_3', core=False)
        LB.append(LBs)
        time.append(times)
        LBs, times = run_all_general('models/mnist_cnn_8layer_5_3', core=False)
        LB.append(LBs)
        time.append(times)
        LBs, times = run_all_general('models/cifar_cnn_5layer_5_3', core=False, cifar=True)
        LB.append(LBs)
        time.append(times)
        LBs, times = run_all_general('models/cifar_cnn_7layer_5_3', core=False, cifar=True, skipsigmoid=True)
        LB.append(LBs)
        time.append(times)
        #LBs, times = run_all_general('models/mnist_cnn_7layer', core=False)
        #LB.append(LBs)
        ...
        LB.append(LBs)
        '''
        LBs, times = run_all_general('/root/mnist-ffnn/mnist_fnn_3layer_128', core=False, onlyrelu=False, ada=False)
        LB.append(LBs)
        time.append(times)
        LBs, times = run_all_general('/root/mnist-ffnn/mnist_fnn_3layer_256', core=False, onlyrelu=False, ada=False)
        LB.append(LBs)
        time.append(times)
        LBs, times = run_all_general('/root/mnist-ffnn/mnist_fnn_5layer_384', core=False, onlyrelu=False, ada=False)
        LB.append(LBs)
        time.append(times)
        LBs, times = run_all_general('/root/mnist-ffnn/mnist_fnn_6layer_512', core=False, onlyrelu=False, ada=False)
        LB.append(LBs)
        time.append(times)
        
        LBs, times = run_all_general('/root/mnist-ffnn/cifa_fnn_3layer_256', core=False, onlyrelu=False, ada=False, cifar=False)
        LB.append(LBs)
        time.append(times)
        LBs, times = run_all_general('/root/mnist-ffnn/cifa_fnn_5layer_384', core=False, onlyrelu=False, ada=False, cifar=False)
        LB.append(LBs)
        time.append(times)
        LBs, times = run_all_general('/root/mnist-ffnn/cifa_fnn_6layer_512', core=False, onlyrelu=False, ada=False, cifar=False)
        LB.append(LBs)
        time.append(times)
